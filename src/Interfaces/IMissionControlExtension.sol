...
interface IMissionControlExtension {
    ...
    function updateRentTiles(address superToken, address renter, PlaceOrder[] memory addTiles, CollectOrder[] memory removeTiles, int96 oldFlowRate, int96 flowRate) external;
